...
//: **Note:** Answers for challenges are always at the bottom of the page

greeting = "Hello, lighthouse!"
...
// greeting is a String, count is an Int
...
// tipAmount is a Double, isOpen is a Bool (can either be true or false)
