...
//: ## Bonus Challenge
//:
//: It may not be obvious, but the types we are using, `String`, `Int`, `Double`, all have methods, bits of code, you can ask them to run. Double and Int have a pretty minimal set of things they can do, but String has a lot! type the name of the variable and a '.' to show the autocomplete menu. From this list you can pick uppercaseString and lowercaseString to change the case of the characters. Print out the uppercase and lowercase versions of the string below:


var schoolName = "Ligthouse Labs"
